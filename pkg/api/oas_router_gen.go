		...
		case '/': // Prefix: "/"
			...
			case 'm': // Prefix: "me"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "DELETE":
						s.handleDeleteMeRequest([0]string{}, elemIsEscaped, w, r)
					case "GET":
				...
				case '/': // Prefix: "/password"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "PATCH":
							s.handleUpdateMyPasswordRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, notAllowedParams{
		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "clients"
				...
				if len(elem) == 0 {
					...
					case "POST":
						...
						r.summary = "Create an OIDC client"
				...
				case '/': // Prefix: "/"
					...
					if len(elem) == 0 {
						...
						case "DELETE":
							...
							r.summary = "Delete an OIDC client"
						...
						case "GET":
							...
							r.summary = "Get an OIDC client by ID"
			...
			case 'm': // Prefix: "me"
				...
				if len(elem) == 0 {
					switch method {
					case "DELETE":
						r.name = DeleteMeOperation
						r.summary = "Delete the authenticated user"
						r.operationID = "deleteMe"
						r.operationGroup = ""
						r.pathPattern = "/me"
						r.args = args
						r.count = 0
					...
					case "PATCH":
						...
						r.summary = "Update the authenticated user's username and/or locale"
				...
				case '/': // Prefix: "/password"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "PATCH":
							r.name = UpdateMyPasswordOperation
							r.summary = "Change the authenticated user's password"
							r.operationID = "updateMyPassword"
							r.operationGroup = ""
							r.pathPattern = "/me/password"
							r.args = args
							r.count = 0
							return r, true
						default:
